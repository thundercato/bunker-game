...
scene = scene
  .replaceAll("private player?: Phaser.Physics.Arcade.Sprite;", "private tunnelPlayer?: Phaser.Physics.Arcade.Sprite;")
  ...
  .replaceAll("this.make.graphics({ x: 0, y: 0, add: false })", "this.make.graphics({ x: 0, y: 0 })")
  .replaceAll("this.make.graphics({x:0,y:0,add:false})", "this.make.graphics({ x: 0, y: 0 })");
